...
const configSchema = z.object({
  ...
  timeouts: z.object({
    request: z.number().int().min(1000).max(300000).default(30000), // 30s
    model: z.number().int().min(1000).max(180000).default(25000),   // 25s
    analysis: z.number().int().min(5000).max(600000).default(120000), // 2min
    verification: z.number().int().min(10000).max(1800000).default(60000), // 1min
  }),
  ...
  security: z.object({
    ...
    maxContractSize: z.number().int().min(1000).max(1000000).default(50000), // 50KB
